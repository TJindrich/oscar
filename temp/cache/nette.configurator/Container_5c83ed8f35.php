<?php
// source: E:\xampp\htdocs\oscar/config/common.neon
// source: E:\xampp\htdocs\oscar/config/services.neon
// source: array
...
class Container_5c83ed8f35 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Forms\UploadFormFactory' => [['02']],
		'App\Models\OscarModel' => [['03']],
	];
	...
	public function createService02(): App\Forms\UploadFormFactory
	{
		return new App\Forms\UploadFormFactory;
	}


	public function createService03(): App\Models\OscarModel
	{
		return new App\Models\OscarModel;
	}
	...
	{
		$service = new App\UI\Home\HomePresenter($this->getService('02'), $this->getService('03'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'E:\xampp\htdocs\oscar/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('E:\xampp\htdocs\oscar/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('E:\xampp\htdocs\oscar/temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_5c83ed8f35
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_5c83ed8f35 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('E:\xampp\htdocs\oscar/temp/cache/latte');
